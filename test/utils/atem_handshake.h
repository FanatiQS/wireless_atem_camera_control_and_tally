...
void atem_handshake_newsessionid_get_verify(uint8_t* packet, uint16_t session_id_expected_new);
...
void atem_handshake_newsessionid_recv_verify(int sock, uint8_t opcode, bool retx, uint16_t session_id, uint16_t session_id_expected_new);
