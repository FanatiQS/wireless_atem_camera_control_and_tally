...
int main(void) {
	...
	RUN_TEST() {
		...
		atem_handshake_sessionid_set(atem.read_buf, ATEM_OPCODE_ACCEPT, true, atem_handshake_sessionid_create(false));
	...
	RUN_TEST() {
		struct atem atem = {0};
		atem_connection_reset(&atem);
		atem_handshake_sessionid_set(atem.read_buf, ATEM_OPCODE_REJECT, true, atem_handshake_sessionid_create(false));
	...
	RUN_TEST() {
		struct atem atem = {0};
		atem_acknowledge_request_set(atem.read_buf, atem_handshake_sessionid_create(true), 0x0001);
	...
	RUN_TEST() {
		struct atem atem = {0};
		atem_acknowledge_response_set(atem.read_buf, atem_handshake_sessionid_create(true), 0x0001);
	...
	RUN_TEST() {
		struct atem atem = {0};
		atem_handshake_sessionid_set(atem.read_buf, ATEM_OPCODE_CLOSING, false, atem_handshake_sessionid_create(true));
	...
	RUN_TEST() {
		...
		atem_handshake_sessionid_set(atem.read_buf, ATEM_OPCODE_CLOSED, false, atem_handshake_sessionid_create(true));
	...
	RUN_TEST() {
		struct atem atem = {0};
		atem_handshake_sessionid_set(atem.read_buf, ATEM_OPCODE_OPEN, false, atem_handshake_sessionid_create(false));
	...
	RUN_TEST() {
		...
		struct atem atem = {0};
		atem_acknowledge_request_set(atem.read_buf, atem_handshake_sessionid_create(false), 0x0001);
